...
public interface StatRepository extends JpaRepository<EndpointHit, Long> {
    ...
    List<ViewStatsDto> getViewStats(LocalDateTime start, LocalDateTime end, String[] uris);
    ...
    @Query("SELECT new ru.practicum.stat.dto.ViewStatsDto(e.app, e.uri, COUNT(DISTINCT e.ip))  " +
            ...
            "GROUP BY e.app, e.uri " +
            "ORDER BY COUNT(e) DESC")
    List<ViewStatsDto> getUniqueViewStats(LocalDateTime start, LocalDateTime end, String[] uris);
}
